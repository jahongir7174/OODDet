# from GridMask p=0.5 to 0.8
# model settings
base = 'https://github.com/SwinTransformer/storage/releases/download/v1.0.0'
ckpt = '{}/swin_large_patch4_window7_224_22k.pth'.format(base)
            ...
            train=dict(type='MOSAICDataset',
                       dataset=dict(type=dataset_type,
                                    ...
                                    pipeline=[dict(type='LoadImageFromFile'),
                                              dict(type='MixAugment', n=3),
                                              dict(type='GridMask', p=0.8),
                                              dict(type='Weather')]),
